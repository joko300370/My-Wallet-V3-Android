...
val applicationModule = applicationContext {
    ...
    context("Payload") {
        ...
        factory {
            ...
            val new: SendPresenterX<SendView> = XlmSendPresenterStrategy(get(), get(), get(), get())
        ...
        factory {
            ...
            object : XlmTransactionSender {
                ...
                override fun sendFunds(from: AccountReference, value: CryptoValue, toAccountId: String): Completable {

                    return Completable.timer(4, TimeUnit.SECONDS)
                        .doOnSubscribe {
                            Timber.d("Simulating: Sending from ${from.label} ${value.formatWithUnit()} to $toAccountId")
                        }
                        .doOnComplete {
                            Timber.d("Simulating: Sent from ${from.label} ${value.formatWithUnit()} to $toAccountId")
                        }
                }
