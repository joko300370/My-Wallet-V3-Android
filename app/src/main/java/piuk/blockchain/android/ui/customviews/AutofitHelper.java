...
/**
 * <p>A helper class to enable automatically resizing {@link androidx.appcompat.widget.AppCompatEditText}`s {@code textSize} to fit
 * within its bounds.
 *
...
public class AutofitHelper {
    ...
    private static float getAutofitTextSize(CharSequence text, TextPaint paint,
        ...
        if (SPEW) Timber.d("low=" + low + " high=" + high + " mid=" + mid +
