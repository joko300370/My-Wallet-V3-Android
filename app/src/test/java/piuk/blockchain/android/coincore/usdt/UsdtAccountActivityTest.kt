...
import piuk.blockchain.android.coincore.erc20.usdt.UsdtCryptoWalletAccount
...
class UsdtAccountActivityTest {
    ...
    private val subject =
        UsdtCryptoWalletAccount(
            payloadManager = payloadManager,
            label = "Text Usdt Account",
            address = "Test Usdt Address",
            fees = mock(),
            erc20Account = usdtAccount,
    ...
    fun setup() {
        ...
        whenever(usdtAccount.ethDataManager).thenReturn(ethDataManager)
    }
    ...
    fun getErc20TransactionsList() {
        ...
        whenever(usdtAccount.getTransactions()).thenReturn(Observable.just(listOf(erc20Transfer)))
        ...
        whenever(usdtAccount.fetchErc20Address()).thenReturn(Observable.just(mock()))

        whenever(usdtAccount.getAccountHash())
        ...
        subject.activity
            ...
            .assertValue {
                it.size == 1 && it[0].run {
                    ...
                    confirmations == 3 &&
                    value == CryptoValue.fromMinor(CryptoCurrency.USDT, 10000.toBigInteger()) &&
                    inputsMap["0x4058a004dd718babab47e14dd0d744742e5b9903"] ==
                        CryptoValue.fromMinor(CryptoCurrency.USDT, 10000.toBigInteger()) &&
                    outputsMap["0x2ca28ffadd20474ffe2705580279a1e67cd10a29"] ==
                        CryptoValue.fromMinor(CryptoCurrency.USDT, 10000.toBigInteger())
                }
            }

        verify(usdtAccount).getTransactions()
    }
}
