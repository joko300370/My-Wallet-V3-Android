...
class SLIP0010TestCase1 {
    ...
    fun m() {
        case1Seed
            .deriveHardenedIndexes() `should equal` "2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7"
    }

    @Test
    fun `m_0'`() {
        case1Seed
            .deriveHardenedIndexes(0) `should equal` "68e0fe46dfb67e368c75379acec591dad19df3cde26e63b93a8e704f1dade7a3"
    }

    @Test
    fun `m_0'_1'`() {
        case1Seed
            .deriveHardenedIndexes(
                0,
                1
...
class SLIP0010TestCase2 {
    ...
    fun m() {
        case2Seed
            .deriveHardenedIndexes() `should equal` "171cb88b1b3c1db25add599712e36245d75bc65a1a5c9e18d76f9f2b1eab4012"
    }

    @Test
    fun `m_0'`() {
        case2Seed
            .deriveHardenedIndexes(0) `should equal` "1559eb2bbec5790b0c65d8693e4d0875b1747f4970ae8b650486ed7470845635"
    }
