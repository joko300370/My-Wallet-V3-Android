...
public class CashAddress {
    ...
    private static CashAddress.VersionPayload decodeVersion(BigInteger version) {
        ...
        return new CashAddress.VersionPayload(scriptType, hashSize);
    }
    ...
    public static String encode(String prefix, String scriptType, byte[] hash) {
        ...
        byte[] words = Bech32.toWords(encodePayload(scriptType, hash));
    ...
    public static CashAddress decode(String address) {
        ...
        CashAddress.VersionPayload versionInfo = decodeVersion(BigInteger.valueOf(data[0]));
    ...
    public static String toLegacy(NetworkParameters networkParameters, String address) {
        ...
        boolean isP2SH = !cashAddress.scriptType.equals(P2PKH);
    ...
    public static String toBech32Url(String base58) {
        LegacyAddress address = LegacyAddress.fromBase58(BchMainNetParams.get(), base58);
        return fromLegacyAddress(address);
    }
