...
public class AccountTest {
    ...
    public void getReceive() {
        ...
        Assert.assertEquals(
            "1GfNtDKUu9KZt8ae7c9UM6NUD1uViZcsEA",
            account.getReceive().getAddressAt(0, Derivation.LEGACY_PURPOSE).getFormattedAddress()
        );
    }
    ...
    public void getChange() {
        ...
        Assert.assertEquals(
            "12boKefnALjsXoQXyHg79aU7qSAFfg5Nze",
            account.getChange().getAddressAt(0, Derivation.LEGACY_PURPOSE).getFormattedAddress()
        );
    }
    ...
    public void getChain() throws Exception {
        ...
        Assert.assertEquals(
            "12boKefnALjsXoQXyHg79aU7qSAFfg5Nze",
            account.getChain(1).getAddressAt(0, Derivation.LEGACY_PURPOSE).getFormattedAddress()
        );
    }
